...
// Default to a versioned Storefront API endpoint; can be overridden via env
export const SHOPIFY_STOREFRONT_API_VERSION = process.env.SHOPIFY_STOREFRONT_API_VERSION || "2024-07"
export const SHOPIFY_STOREFRONT_API_ENDPOINT = process.env.SHOPIFY_STOREFRONT_API_ENDPOINT || `https://${SHOPIFY_STORE_DOMAIN}/api/${SHOPIFY_STOREFRONT_API_VERSION}/graphql.json`